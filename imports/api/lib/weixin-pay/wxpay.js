...
WXPay.mix = function () {
  switch (arguments.length) {
    case 1:
      ...
      break
    case 2:
      var wechatKey = arguments[0].toString()
      var fn = arguments[1]
      if (WXPay.prototype.hasOwnProperty(wechatKey)) {
        throw new Error('Prototype method exist. method: ' + wechatKey)
      }
      WXPay.prototype[wechatKey] = fn
      break
  }
}
...
WXPay.mix('getBrandWCPayRequestParams', function (order, fn) {
  ...
  var _this = this
  this.createUnifiedOrder(order, function (e, data) {
    var reqparam = {
